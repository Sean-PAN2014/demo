...
public class Invests2 {
	public static LocalDate END = LocalDate.parse("2018-08-07");

	public static SimpleInvest fundFranklin() {
		LocalDate start = LocalDate.parse("2016-12-20");
		SimpleInvest simpleInvest = new SimpleInvest(25000*6.828, 2832.72*6.828, start, END);
	...
	public static SimpleInvest fundFedility() {
		...
		SimpleInvest simpleInvest = new SimpleInvest(104_000, 20197.39, start, END);
		simpleInvest.setName("富达科技");
		return simpleInvest;
	}

	public static MultidayInvest fundAbc() {
	...
	public static MultidayInvest ant() {
		MultidayInvest multidayInvest = new MultidayInvest();
